...
# Здесь опущены аналогичные хендлеры для управления аватаром, паролем, именем, отправки сообщений и т.д. (они есть в полной версии, но для краткости не включены, так как мы фокусируемся на исправлении игр. При необходимости добавлю позже.)
